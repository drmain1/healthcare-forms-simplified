...
export const createMinimalSurveyCreator = (): SurveyCreator => {
          ...
          elements: [
            {
              ...
              validators: [{
                type: 'expression',
                expression: "!({ros_constitutional} contains 'none') or {ros_constitutional}.length = 1",
                text: 'Please uncheck other options when "None of the above" is selected'
              }]
            },
            {
              type: 'checkbox',
        ...
        },
        {
          ...
          elements: [
            ...
            },
            {
              ...
              choices: ['Anemia', 'Blood disorder', 'HIV/AIDS'],
              colCount: 1
            },
            {
              type: 'checkbox',
        ...
        },
        {
          ...
          elements: [
            ...
            },
            {
              ...
              name: 'ros_headneck',
              title: 'Head/Neck',
              choices: ['Headaches', 'Migraines', 'Painful neck', 'Stiff neck'],
              colCount: 2
            },
            {
              type: 'checkbox',
  ...
  creator.toolbox.addItem(reviewOfSystemsPanel); */
