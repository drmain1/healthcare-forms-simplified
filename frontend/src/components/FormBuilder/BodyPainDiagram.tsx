...
// Embedded SVG content from JoLp9f01 (1).svg
const BODY_SVG_CONTENT = `
<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="auto" version="1.0" viewBox="0 0 300 300">
...
export const BodyPainDiagram: React.FC<BodyPainDiagramProps> = ({
  ...
  useEffect(() => {
    // Use embedded SVG content for reliability
    setSvgContent(BODY_SVG_CONTENT);
  }, []);
